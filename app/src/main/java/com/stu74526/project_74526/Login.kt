...
fun FinalPart(
    ...
    onclick: () -> Unit = {}
) // Text ask if you're not a member, register now
{
    Row(modifier = modifier)
    {

        CustomText(
            textString = firstString, color = tColor,
...
) // Text fields, Login Button and google and apple icons
{
    Column(
        modifier = Modifier
            .fillMaxWidth()
...
fun TextFieldPart(sColor: Color, tColor: Color) // Text fields for email and password
{
    Column(
        modifier = Modifier
            .fillMaxWidth()
            .height(130.dp), horizontalAlignment = Alignment.CenterHorizontally,
...
fun RoundedTextField(
    textString: String, modifier: Modifier,
...
fun TextWithBoxes(textString: String, sColor: Color) // Text between two boxes
{
    ...
    )
    {
        ...
        CustomText(
            textString = textString, color = sColor,
...
) // Custom Text with default parameters
{
    Text(
        text = textString,
        modifier = modifier,
